...
bool Application::InitializeVulkan()
{
    ...
    //
    InitOffscreen(
        &m_deviceContext, m_deviceContext.m_swapChain.m_windowWidth, m_deviceContext.m_swapChain.m_windowHeight);
...
void Application::DrawFrame()
{
    ...
    m_deviceContext.BeginRenderPass();
    {
        ...
        descriptor.BindImage(
            VK_IMAGE_LAYOUT_GENERAL, g_offscreenFrameBuffer.m_imageColor.m_vkImageView, Samplers::m_samplerStandard, 0);
